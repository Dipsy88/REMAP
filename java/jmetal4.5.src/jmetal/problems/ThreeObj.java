 ...
 */
public class ThreeObj extends Problem {
	 ...
	 */
	public ThreeObj(String solutionType) throws ClassNotFoundException {

		this(solutionType, 489); // 30 variables by default
	} // ZDT3
	 ...
	 *            The solution type must "Real", "BinaryReal, and "ArrayReal".
	 */
	public ThreeObj(String solutionType, Integer numberOfVariables) {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		if (caseOutTemp.size() > 0) {
			...
			// int counter = caseOutTemp.size();
			// if (skipTC.size() > 0) {
			// Collections.shuffle(skipTC);
			//
			// for (String name : skipTC) {
			// cases[counter] = name;
			// counter++;
			// }
			// }
