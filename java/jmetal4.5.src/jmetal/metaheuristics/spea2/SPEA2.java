...
public class SPEA2 extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		//
		// fileTime.write(solutionSet.get(i).getObjective(0) + " "
		// + solutionSet.get(i).getObjective(1) + " "
		// + solutionSet.get(i).getObjective(2) + " "
		// + solutionSet.get(i).getObjective(3) + " "
	...
	public void createFile(int count) throws Exception {
		// fileName = new File("output/ciscoPrior/OneRun/spea2/spea2" + count);
		// fileName = new File("output/kongsbergSelect/OneRun/spea2/spea2" +
		// count);
		fileName = new File("output/defects4j/minimization/chart/OneRun/spea2/spea2" + count);
		// fileName = new File(
		// "output/defects4j/prioritization/time/OneRun/spea2/spea2"
		// + count);
		// fileName = new File(
		// "output/defects4j/selection/math/OneRun/spea2/spea2" + count);
		// fileName = new File(
		// "output/testingResourceAllocation/OneRun/spea2/spea2" + count);
		// fileName = new File(
		// "output/IntegrationTestOrderProblem/OneRun/spea2/spea2" + count);
