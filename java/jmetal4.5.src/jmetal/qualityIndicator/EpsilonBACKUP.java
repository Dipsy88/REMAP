...
public class EpsilonBACKUP {
	...
	// static String [] algorithmNameList_ = new String[] {"ea", "nsgaii",
	// "spea2", "cellde", "ibea", "mocell", "avm","rs"};
	static String[] algorithmNameList_ = new String[] { "paes",
			"cbea_consistent", "cbea", "greedy", "mocell", "nsgaii", "spea2",
			"rs" };
	private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/";
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/Epsilon/";

	private static String nonDominated = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Analysis/defects4j/prioritization/referenceFront/nondominated";
	...
	public static void main(String[] args) throws Exception {
		...
		for (int algorithmIndex = 0; algorithmIndex < algorithmNameList_.length; algorithmIndex++) {
			...
			for (int row = 1; row <= 50; row++) {
				...
				EpsilonBACKUP qualityIndicator = new EpsilonBACKUP();
	...
	public static void createFile(String algorithm) throws Exception {
		...
		// System.out.println("/Users/Dipesh/OneDrive/Papers/JournalShuai/Analysis/"+numberCases+"/epsilon/"
		// + algorithm+ ".txt");
