 ...
 * 257-271, 1999.
 */
public class HypervolumeBACKUPforR_5O_1run {
	static int numValues = 0;
	public jmetal.qualityIndicator.util.MetricsUtil utils_;
	private static File fileName;
	private static BufferedWriter file;

	private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/minimization/OneRun/";
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/minimization/OneRun/HV/";

	// private static String inFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/ciscoMinim/OneRun/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/ciscoMinim/OneRun/HV/";
	 ...
	 */
	public HypervolumeBACKUPforR_5O_1run() {
	...
	public static void main(String args[]) throws Exception {
		for (int algorithmRun = 0; algorithmRun < algorithmNameList_.length; algorithmRun++) {
			...
			for (int row = 1; row < 51; row++) {
				...
				HypervolumeBACKUPforR_5O_1run qualityIndicator = new HypervolumeBACKUPforR_5O_1run();
	...
	public static double[][] readFile(int row, String algorithm) {
		double[][] solutionFront = new double[200][5];
		double[][] trueFront;
		int counter;
