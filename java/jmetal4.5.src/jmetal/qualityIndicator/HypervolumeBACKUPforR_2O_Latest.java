 ...
 * 257-271, 1999.
 */
public class HypervolumeBACKUPforR_2O_Latest {
	...
	// "/Users/Dipesh/OneDrive/Papers/Journal
	// ICST/Result/defects4j/prioritization/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal
	// ICST/Result/defects4j/prioritization/HV/";

	// private static String inFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/selection/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/selection/HV/";

	private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Revision ICST 2017/Result/2O/val/";
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Revision ICST 2017/Result/2O/HV/";

	// static String[] algorithmNameList_ = new String[] { "cbea_ext", "cbea",
	// "greedy", "mocell", "nsgaii", "paes", "rs", "spea2", "ibea",
	// "abyss" };

	static String[] algorithmNameList_ = new String[] { "nsgaii", "adaptive" };

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public HypervolumeBACKUPforR_2O_Latest() {
	...
	public static void main(String args[]) throws Exception {
		for (int algorithmRun = 0; algorithmRun < algorithmNameList_.length; algorithmRun++) {
			...
			for (int row = 1; row < 51; row++) {
				...
				int numberObjectives = 2;

				// Create a new instance of the metric
				HypervolumeBACKUPforR_2O_Latest qualityIndicator = new HypervolumeBACKUPforR_2O_Latest();
	...
	public static double[][] readFile(int row, String algorithm) {
		double[][] solutionFront = new double[100][2];
		double[][] trueFront;
		int counter;
		// System.out.println("/Users/Dipesh/OneDrive/Papers/ICTSS_2016/Anaylsis/"+numberCases+"/NoBudget/20/"+algorithm+"/"+algorithm+row);
		try {
			BufferedReader in = new BufferedReader(new FileReader(inFolderNSGAII + algorithm + "/" + algorithm + row));
