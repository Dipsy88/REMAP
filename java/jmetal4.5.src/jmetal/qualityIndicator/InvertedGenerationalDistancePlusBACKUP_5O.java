 ...
 * Inst. Technol. (1998)
 */
public class InvertedGenerationalDistancePlusBACKUP_5O {
	...
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/minimization/IGD/";
	...
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/ciscoMinim/IGD/";
	private static String nonDominated = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Analysis/ciscoMinim/referenceFront/nondominated";

	/**
	 * Constructor. Creates a new instance of the generational distance metric.
	 */
	public InvertedGenerationalDistancePlusBACKUP_5O() {
	...
	public static void main(String args[]) throws Exception {
		...
		for (int algorithmIndex = 0; algorithmIndex < algorithmNameList_.length; algorithmIndex++) {
			...
			for (int row = 1; row <= 50; row++) {
				...
				InvertedGenerationalDistancePlusBACKUP_5O qualityIndicator = new InvertedGenerationalDistancePlusBACKUP_5O();
