 ...
 * 257-271, 1999.
 */
public class HypervolumeBACKUPforR_4O_1run {
	...
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/OneRun/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/OneRun/HV/";

	// private static String inFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/selection/OneRun/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/selection/OneRun/HV/";

	// private static String inFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/ciscoPrior/OneRun/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/ciscoPrior/OneRun/HV/";

	// private static String inFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/kongsbergSelect/OneRun/";
	// private static String outFolderNSGAII =
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/kongsbergSelect/OneRun/HV/";

	private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/IntegrationTestOrderProblem/OneRun/";
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/IntegrationTestOrderProblem/OneRun/HV/";

	static String[] algorithmNameList_ = new String[] { "cbea", "spea2",
			"mocell", "nsgaii", "paes", "cbea_consistent" };

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public HypervolumeBACKUPforR_4O_1run() {
	...
	public static void main(String args[]) throws Exception {
		for (int algorithmRun = 0; algorithmRun < algorithmNameList_.length; algorithmRun++) {
			...
			for (int row = 1; row < 51; row++) {
				...
				HypervolumeBACKUPforR_4O_1run qualityIndicator = new HypervolumeBACKUPforR_4O_1run();
	...
	public static double[][] readFile(int row, String algorithm) {
		double[][] solutionFront = new double[200][4];
		double[][] trueFront;
		int counter;
