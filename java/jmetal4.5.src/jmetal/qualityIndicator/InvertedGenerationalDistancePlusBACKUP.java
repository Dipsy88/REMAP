 ...
 * Inst. Technol. (1998)
 */
public class InvertedGenerationalDistancePlusBACKUP {
	...
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/IntegrationTestOrderProblem/IGD/";
	private static String nonDominated = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Analysis/IntegrationTestOrderProblem/referenceFront/nondominated";
	 ...
	 */
	public InvertedGenerationalDistancePlusBACKUP() {
	...
	public static void main(String args[]) throws Exception {
		...
		for (int algorithmIndex = 0; algorithmIndex < algorithmNameList_.length; algorithmIndex++) {
			...
			for (int row = 1; row <= 50; row++) {
				...
				InvertedGenerationalDistancePlusBACKUP qualityIndicator = new InvertedGenerationalDistancePlusBACKUP();
