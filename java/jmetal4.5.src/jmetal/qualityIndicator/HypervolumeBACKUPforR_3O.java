 ...
 * 257-271, 1999.
 */
public class HypervolumeBACKUPforR_3O {
	...
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/testingResourceAllocation/HV/";
	...
	static String[] algorithmNameList_ = new String[] { "spea2",
			"cbea_consistent", "mocell", "nsgaii", "paes", "rs", "cbea",
			"greedy" };

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public HypervolumeBACKUPforR_3O() {
	...
	public static void main(String args[]) throws Exception {
		for (int algorithmRun = 0; algorithmRun < algorithmNameList_.length; algorithmRun++) {
			...
			for (int row = 1; row < 51; row++) {
				...
				HypervolumeBACKUPforR_3O qualityIndicator = new HypervolumeBACKUPforR_3O();
