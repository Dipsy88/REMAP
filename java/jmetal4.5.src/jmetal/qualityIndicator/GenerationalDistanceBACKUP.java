...
//  static String [] algorithmNameList_ = new String[] {"ea", "nsgaii", "spea2", "cellde", "ibea", "mocell", "avm","rs"};
  static String[] algorithmNameList_ = new String[] {"paes", "cbea_ext", "cbea",
		"greedy", "mocell", "nsgaii", "rs", "spea2", "ibea",
		"abyss" };
  private static String inFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/";
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/GD/";
...
//    } // if
	  int numberObjectives = 4;	
	    ...
	    // STEP 1. Create an instance of Generational Distance
					    ...
					    double [][] solutionFront = readFile(row, algorithmNameList_[algorithmIndex]);
