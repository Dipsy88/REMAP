 ...
 * 257-271, 1999.
 */
public class HypervolumeBACKUPforR_2O {
	...
	// "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/defects4j/prioritization/HV/";
	...
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Result/IntegrationTestOrderProblem/HV/";

	static String[] algorithmNameList_ = new String[] { "spea2",
			"cbea_consistent" };

	// static String[] algorithmNameList_ = new String[] { "spea2", "greedy",
	// "mocell", "nsgaii", "paes", "rs", "cbea", "cbea_consistent" };

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public HypervolumeBACKUPforR_2O() {
	...
	int numberOfObjectives) {
		...
		// code)
		return this.calculateHypervolume(normalizedFront,
				normalizedFront.length, numberOfObjectives);
	}// hypervolume
	...
	public static void main(String args[]) throws Exception {
		for (int algorithmRun = 0; algorithmRun < algorithmNameList_.length; algorithmRun++) {
			...
			for (int row = 1; row < 51; row++) {
				...
				HypervolumeBACKUPforR_2O qualityIndicator = new HypervolumeBACKUPforR_2O();
