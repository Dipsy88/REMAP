...
public class QualityIndicatorBACKUP_3O {
	...
	private static String outFolderNSGAII = "/Users/Dipesh/OneDrive/Papers/Journal ICST/Analysis/TestingResourceAllocation/referenceFront/";

	static String[] algorithmNameList_ = new String[] { "cbea_consistent",
			"cbea", "mocell", "nsgaii", "paes", "spea2" };

	public QualityIndicatorBACKUP_3O() {
	...
	public static void main(String[] args) throws IOException {
		...
		QualityIndicatorBACKUP_3O qi = new QualityIndicatorBACKUP_3O();
