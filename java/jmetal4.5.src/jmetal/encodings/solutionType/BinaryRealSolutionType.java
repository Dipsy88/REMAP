...
public class BinaryRealSolutionType extends SolutionType {
	...
	public Variable[] createVariables() {
		...
		for (int var = 0; var < problem_.getNumberOfVariables(); var++) {
			...
			variables[var] = new BinaryReal(problem_.getPrecision(var), problem_.getLowerLimit(var),
	...
	@Override
	public Variable[] createVariables(double[] values) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Variable[] createVariables(boolean isInteger) {
		// TODO Auto-generated method stub
		return null;
	}
